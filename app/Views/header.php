...
<head>
  ...
  <link rel="stylesheet" href="public/layout/assets/css/pages/contact.css">
  <link rel="stylesheet" href="public/layout/assets/css/pages/about-01.css">
  ...
  <header id="masthead" class="masthead">
    ...
    <div class="header-middle">
      <div class="container">
        <div class="row">
          <div class="col-sm-3">
            <h1><a class="navbar-brand hidden-xs" href="./"><img src="public/layout/images/upload/logo2.png" alt="Site Logo" style="max-width: 70%; margin-left: 30px; margin-top: -20px;"></a></h1>
          </div>
          <div class="col-sm-7">
      ...
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand visible-xs" href="./">
            <img src="public/layout/images/upload/logo.jpg" alt="Site Logo">
          </a><!-- /.navbar-brand -->
        </div>
